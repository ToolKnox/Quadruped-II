...
rospack.get_path('quadruped_peripheral_interfacing') + "/lib/emptybatterystatus_white.png"

class quadrupedDisplayNode:
    def __init__(self):
        rospy.init_node('quadruped_display_node')
    ...
    def run(self):
        try:
            ...
            # draw.text((60, -15), 'quadruped', fill="RED", font=Font3)
            ...
            batt_status = Image.open(rospack.get_path('quadruped_peripheral_interfacing') + "/lib/emptybatterystatus_white.png")
