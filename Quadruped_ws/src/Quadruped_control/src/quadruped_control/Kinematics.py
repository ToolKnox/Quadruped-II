...
from quadruped_control.util import RotMatrix3D, point_to_rad
...
def leg_explicit_inverse_kinematics(r_body_foot, leg_index, config):
    ...
    config : Configuration class
        Configuration class which contains all of the parameters of the quadruped (link lengths, max velocities, etc)
