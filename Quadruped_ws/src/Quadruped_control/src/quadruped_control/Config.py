import numpy as np
# from quadruped_servo_interfacing.ServoCalibration import MICROS_PER_RAD, NEUTRAL_ANGLE_DEGREES
from quadruped_input_interfacing.HardwareConfig import PS4_COLOR, PS4_DEACTIVATED_COLOR
